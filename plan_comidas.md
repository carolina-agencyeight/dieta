...
<!-- INSTRUCCIONES DE USO:
  Estados día: ⬜ Pendiente | ✅ Completado | ⏭️ Saltado
  Ingredientes: 🟢→🟡 = estado antes → estado después de usar
  - [ ] = deducción planificada (aún no aplicada al inventario)
  - [x] = deducción ya aplicada al inventario.md
  Este archivo crece semana a semana — nunca se editan semanas pasadas.
-->
...
#### Almuerzo
**Arroz con capón y ensalada de espinaca**
- [ ] Arroz blanco 🟢→🟢
- [ ] Capón 🔴→🔴 ⚠️ COMPRAR
- [ ] Espinaca 🔴→🔴 ⚠️ COMPRAR
- [ ] Aceite de oliva 🟢→🟢
...
#### Almuerzo
**Pasta larga con pesto y jamón serrano**
- [ ] Pasta larga 🟡→🔴
- [ ] Salsa pesto 🟢→🟡
- [ ] Jamón serrano 🟡→🔴
...
#### Almuerzo
> Sin almuerzo programado — come fuera

#### Merienda
> Sin merienda programada
